...
function construction_landing_page_site_header(){
    $phonelabel   = get_theme_mod( 'epic_construction_header_phone_label',__( 'Phone Number','epic-construction' ) );
    $emaillabel   = get_theme_mod( 'epic_construction_header_email_label',__( 'Email','epic-construction' ) );
    $phonenumber  = get_theme_mod( 'construction_landing_page_phone' ); 
    $emailaddress = get_theme_mod( 'epic_construction_header_email' ); 
    $ed_social    = get_theme_mod( 'epic_construction_ed_header_social_links',true );
    ?>
    <header id="masthead" class="site-header" role="banner" itemscope itemtype="https://schema.org/WPHeader">
        <?php if( $phonenumber || $ed_social ){ ?>
            <div class="top-bar">
                <div class="container">
                <?php if( ! empty( $phonenumber ) ){ 
                    echo '<div class="phone-holder">';
                        esc_html_e( 'Call Us Today','epic-construction' ); ?>
                        <a href="<?php echo esc_url( 'tel:'.preg_replace( '/[^\d+]/', '', $phonenumber ) ); ?>"><?php echo esc_html( $phonenumber ); ?></a>
                    <?php
                    echo '</div>';
                } 
                if( $ed_social ) do_action( 'epic_construction_social_link' );  ?>
                </div>
            </div>
        <?php } ?>
        <div class="header-t">
    ...
    <div class="mobile-header">
        ...
        <div class="mobile-menu">
            ...
            <nav id="mobile-navigation" class="primary-navigation">        
                ...
                <div class="mobile-menu-title" aria-label="<?php esc_attr_e( 'Mobile', 'epic-construction' ); ?>">
                    <?php
                        wp_nav_menu( array(
                ...
                <?php if( $ed_social ) do_action( 'epic_construction_social_link' );  ?>
...
function construction_landing_page_phone_link( $menu, $args ){
    $url = get_theme_mod( 'epic_construction_header_get_a_quote_url' );
    if( $url && $args->theme_location == 'primary' ){
        $menu .= '<li><a href="'. esc_url( $url ) .'" class="request-link">' . esc_html__( 'Get A Quote','epic-construction' ) . '</a></li>';        
    }
    return $menu; 
}
...
function construction_landing_page_customizer_theme_info( $wp_customize ) {
    ...
    $wp_customize->add_section( 'theme_info' , array(
		'title'       => __( 'Demo and Documentation' , 'epic-construction' ),
		'priority'    => 6,
		));
    ...
    $theme_info = '';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Documentation', 'epic-construction' ) . ': </label><a href="' . esc_url( 'https://docs.rarathemes.com/docs/epic-construction/' ) . '" target="_blank">' . __( 'here', 'epic-construction' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Demo', 'epic-construction' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/previews/?theme=epic-construction' ) . '" target="_blank">' . __( 'here', 'epic-construction' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Theme Info', 'epic-construction' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/wordpress-themes/epic-construction/' ) . '" target="_blank">' . __( 'here', 'epic-construction' ) . '</a></span><br />';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support Ticket', 'epic-construction' ) . ': </label><a href="' . esc_url( 'https://rarathemes.com/support-ticket/' ) . '" target="_blank">' . __( 'here', 'epic-construction' ) . '</a></span><br />';
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Rate this theme', 'epic-construction' ) . ': </label><a href="' . esc_url( 'https://wordpress.org/support/theme/epic-construction/reviews/' ) . '" target="_blank">' . __( 'here', 'epic-construction' ) . '</a></span><br />';

<?php
/**
 * Epic_Construction Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Epic_Construction_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Epic_Construction_Repeater_Setting extends WP_Customize_Setting {

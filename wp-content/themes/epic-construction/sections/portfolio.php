    ...
    <div class="inner-wrapper">
        <?php 
			...
			if( $portfolio_posts && $qry->have_posts() ){ ?>
				        ...
				        <div class="col">
                            <div class="img-holder">
                                ...
                                if( has_post_thumbnail() ){
                                    the_post_thumbnail( 'epic-construction-portfolio', array( 'itemprop' => 'image' ) );
                                }else{ 
                                    construction_landing_page_get_fallback_svg( 'epic-construction-portfolio' );
                                } ?>
                            </div>
                            <div class="blp-text-holder">
                                ...
                                <a href="<?php the_permalink(); ?>" class="btn-more"><?php esc_html_e( 'Read More','epic-construction' ); ?></a>
                            </div>
                        </div>
                   	<?php 
                   }
                ...
                <?php epic_construction_get_section_header( $section_title,'projects' ); ?>
            <?php 
            } 
        ?>
    </div>

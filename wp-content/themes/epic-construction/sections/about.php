    ...
    <div class="container">
      <?php construction_landing_page_get_section_header( $section_title );
			...
			if( $posts_arr && $qry->have_posts() ){ ?>
				        ...
				        <div class="col">
                            <div class="img-holder">
                                ...
                                if( has_post_thumbnail()){ 
                                    the_post_thumbnail( 'epic-construction-about', array( 'itemprop' => 'image' ) ); 
                                }else{
                                    construction_landing_page_get_fallback_svg( 'epic-construction-about' );
                                } ?>
                                </a>
    	                    </div>
                ...
                <?php epic_construction_get_section_header( $section_title,'about' ); ?>
            <?php 
            } 
        ?>
    </div>
